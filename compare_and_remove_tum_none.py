...
class Compare2DMapAndImage:
    def __init__(self):
        ...
        self.img_height = 480 #540
        self.img_width = 640 #960
    ...
    def draw_tags_boxes(self, projected_image, bounding_boxes, obj,
        ...
        for single_obj, ((tlx, tly), (brx, bry)), color in zip(obj, bounding_boxes, class_to_color.values()):
            if single_obj['label']=="none":
                continue            # get tag_box positions
    ...
    def projectLandmarksToImage_removeoverlap(self, position, orientation,
        ...
        # camToBody = np.array([[0, 0, 1], [-1, 0, 0], [0, -1, 0]])  # R_B_C
        camToBody = np.array([[1, 0, 0], [0, 1, 0], [0, 0, 1]])  # for tum
        ...
        for i, (point_3d, landmark_key, point_2d, point_3d_camera_frame) in enumerate(
            ...
            if 0 <= x < self.img_width and 0 <= y < self.img_height:
                ...
                if ((brx-tlx) * (bry-tly))/(640*480) < 0.8:
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        rospy.sleep(5)  # Simulate processing time 10
